...
INSERT INTO SpotifyClone.plans (plan_type, plan_prices)
VALUES
  ('gratuito', 0),
  ('familiar', 7.99),
  ('universitario', 5.99),
...
INSERT INTO SpotifyClone.users (user_name, user_age, sub_date, plan_id)
VALUES
...
INSERT INTO SpotifyClone.songs (song_name, song_length, artist_id, album_id)
VALUES
  ('Soul For Us', 200, 1, 1),
